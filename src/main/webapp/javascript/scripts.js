...
$(document).ready(function() {
	...
	$('#teamNameFilterInput').autocomplete({
		source: function(request, response) {
			$.ajax({
				url: "http://localhost:8080/rest/api/players/filterTeamNames",
				type: "GET",
				contentType: "text/plain",
				dataType: "json",
				data: {
				...
				success: function(teamNamesReturned) {
					response(teamNamesReturned);
				},
				error: function() {
					response([]);
				}
